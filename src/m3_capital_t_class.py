...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def clone(self):
        ...
        intersection_center = rg.Point(self.v_rect.corner_2.x - (letter_thickness/2),
                                       self.v_rect.corner_2.y - (letter_thickness/2))
        width = self.h_rect.corner_2.x - self.h_rect.corner_1.x
        height = (self.v_rect.corner_1.y - self.v_rect.corner_2.y)/2
